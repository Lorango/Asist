...
static_image_0 = natrix.Static_image('more',
                                     'grafics/podmorje.png',
                                     1,
                                     (0.986436498, 1.125))
    ...
    def lmb_down(self):
        ...
        if natrix.full_screen:
            try:
                ...
                # nije nužno u praksi ne bi trabalo ničemu služit
                self.opis.rect.topleft = natrix.scale((-600, 40))
            except:
                print('Rezolucija je veća od trenutne rezulucije prikaza!')
